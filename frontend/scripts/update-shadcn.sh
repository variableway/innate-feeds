#!/usr/bin/env bash
# Update all vendored shadcn/ui components to the latest registry version.
# Components live in src/components/ui/ (see components.json, style: base-vega / Base UI).
set -euo pipefail
