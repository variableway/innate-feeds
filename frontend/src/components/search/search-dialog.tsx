...
import { FileText, Keyboard, Loader2, Search, Settings, Sparkles } from "lucide-react";
...
export function SearchDialog() {
  ...
  useEffect(() => {
    ...
    searchAPI
      .search(debouncedQuery, searchMode)
      .then((res) => {
        if (cancelled) return;
  ...
  const modeLabel: Record<string, string> = {
    keyword: t("search.mode.keyword"),
    semantic: t("search.mode.semantic"),
    hybrid: t("search.mode.hybrid"),
  };
