...
// Feed represents a feed source. It can be an RSS/Atom feed, a TrendRadar
// platform, or any other adapter-supported source.
type Feed struct {
	ID         int64  `json:"id"`
	...
	SourceType string `json:"source_type"` // "rss" (default), "trendradar", etc.
	CreatedAt  int64  `json:"created_at"`
	UpdatedAt  int64  `json:"updated_at"`
