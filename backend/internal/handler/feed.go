...
import (
	...
	"github.com/innate/hub/internal/pkg/httpc"
...
type createFeedRequest struct {
	...
	SourceType string `json:"source_type"` // "rss" (default) or "trendradar"
}
...
func (h *Handler) createFeed(c *gin.Context) {
	...
	// Only validate URL for RSS feeds; trendradar uses local file paths.
	if req.SourceType != "trendradar" {
...
func (h *Handler) updateFeed(c *gin.Context) {
	...
	if req.SourceType != nil {
		params.SourceType = req.SourceType
	}
