-- PostgreSQL: split runtime fetch metadata from static feed config.
...
ALTER TABLE feeds DROP COLUMN IF EXISTS last_build;
ALTER TABLE feeds DROP COLUMN IF EXISTS last_failure_at;
ALTER TABLE feeds DROP COLUMN IF EXISTS failure;
ALTER TABLE feeds DROP COLUMN IF EXISTS failures;
