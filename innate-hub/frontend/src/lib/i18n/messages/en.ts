export const enMessages = {
  ...
  "settings.apiKeys.createDescription": "Create a key for programmatic access to the API.",
  "settings.apiKeys.namePlaceholder": "Key name (e.g. InsForge integration)",
  "settings.apiKeys.create": "Create",
  "settings.apiKeys.listTitle": "Your API Keys",
  "settings.apiKeys.loadError": "Failed to load API keys",
  "settings.apiKeys.createError": "Failed to create API key",
  "settings.apiKeys.deleteSuccess": "API key deleted",
  "settings.apiKeys.deleteError": "Failed to delete API key",
  "settings.apiKeys.copied": "Copied to clipboard",
  "settings.apiKeys.empty": "No API keys yet.",
  "settings.apiKeys.unnamed": "Unnamed",
  "settings.apiKeys.created": "Created",
  "settings.apiKeys.lastUsed": "Last used",
  "settings.apiKeys.createdTitle": "API Key Created",
  "settings.apiKeys.createdDescription": "Copy this key now. You will not be able to see it again.",
} as const;
